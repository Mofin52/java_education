...
/**
 * Comparator to sort departments in ascending order.
 * @author Alexander Velikorechin
 * @since 26.08.2017
 */

public class CompareDepartmentsAscending implements Comparator<Department> {
    /**
     ...
     * @return 0 if equals, >0 if second is bigger, <0 if second is smaller
     */
    @Override
    public int compare(Department department, Department t1) {
        ...
        return depOneStr.containsAll(depTwoStr) || depTwoStr.containsAll(depOneStr) ? depOneStr.size() - depTwoStr.size() : department.getCode().compareTo(t1.getCode());
    }
}
